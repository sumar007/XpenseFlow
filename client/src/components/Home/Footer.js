    ...
    <div class="Ecommerce-Website-Footer-Section-bg pb-5 pt-5">
        <div class="container">
            <div class="row">
                    ...
                    <div class="d-flex flex-column justify-conent-start justify-conent-md-start ">
                        ...
                        <div class="d-flex flex-row justify-content-md-start justify-conent-center  mb-3">
                            <div class="Ecommerce-Website-Footer-Section-logo-card mr-2">
                                <i class="fa fa-google" style={{color:"#fff"}} aria-hidden="true"></i>
                            </div>
                            <div class="Ecommerce-Website-Footer-Section-logo-card mr-2">
                        ...
                        <div class="text-center text-md-left">
                            <h1 class="Ecommerce-Website-Footer-Section-address">Malakpet, Hyderabad</h1>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3">
                    <div>
                        <h1 class="Ecommerce-Website-Footer-Section-heading">Get to know us</h1>
                ...
                <div class="col-6 col-md-6 col-lg-3">
                    <div>
                        <h1 class="Ecommerce-Website-Footer-Section-heading">Contact with us</h1>
                ...
                <div class="col-6 col-md-6 col-lg-3">
                    <div>
                        <h1 class="Ecommerce-Website-Footer-Section-heading">Let Us Help You</h1>
            ...
            <div class="d-flex flex-row justify-content-center">
                ...
                <div class="ml-2 mt-1">
                    <h1 class="Ecommerce-Website-Footer-Section-address">2023 Xpense Flow</h1>
                </div>
            </div>
        </div>
    </div>
