...
function Pricing() {
    return (
        <div className='pricing-container'>
            <div className='pricing-text'>
                ...
                <p>BigTime helps professional services businesses operate more effectively to better plan, manage, and get paid for client work.</p>
            </div>
  ...
  <div className='ready-container'>
    ...
    <div className='text-container'>
      <h1 className='started'>Ready To Get Started</h1><br/>
